 ...
 *
 * StatusCodes provides named constants for HTTP protocol status codes.
 * Written for the Recess Framework (http://www.recessframework.com/)
 *
 * @author Kris Jordan
 * @license MIT
 */
class HttpCodes
{
     ...
     * @return string
     */
    public static function buildHttpHeaderFor($code)
    {
    ...
    {
        return isset(self::$messages[$code]) ? self::$messages[$code] : 'UNKNOWN';
    }
